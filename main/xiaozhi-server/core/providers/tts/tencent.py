...
class TTSProvider(TTSProviderBase):
    ...
    def __init__(self, config, delete_audio_file):
        ...
        self.api_url = "https://tts.tencentcloudapi.com"
    ...
    async def text_to_speak(self, text, output_file):
        ...
        request_json = {
            ...
            "Codec": self.audio_file_type,
            "Volume": self.volume,
            "Speed": self.speed,
            "SampleRate": self.conn.sample_rate,
        }
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                if response_data.get("Response", {}).get("Error") is not None:
                    ...
                    raise Exception(
                        f"API: {error_info['Code']}: {error_info['Message']}"
                    )
                ...
                if audio_bytes:
                    ...
                    raise Exception(f"{__name__}: : {response_data}")
            else:
                raise Exception(
