...
function getVoiceDisplayName(ttsVoiceId: string) {
  ...
  console.log('===  ===')
  console.log('ID:', ttsVoiceId)
  console.log('TTS:', formData.value.ttsModelId)
...
function updateDisplayNames() {
  ...
  console.log(':', displayNames.value.voiceprint)
}
...
async function onPickerConfirm(type: string, value: any, name: string) {
  ...
  switch (type) {
    ...
    case 'voiceprint':
      ...
      displayNames.value.voiceprint = name
      break
    case 'report':
...
function handleTools() {
  console.log(':', formData.value.functions)
