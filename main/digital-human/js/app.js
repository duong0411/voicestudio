...
import { localizeDOM } from './ui/localization.js?v=0205';
import { initSourceSelectorFromUrl, initSourceSelectorUI, applyInputSourceToWindow } from './ui/source-selector.js?v=0205';
...
class App {
    ...
    async checkMicrophoneAvailability() {
        try {
            ...
            log(`: ${isAvailable ? '' : ''}`, isAvailable ? 'success' : 'warning');
        } catch (error) {
                ...
                return new Promise(async (resolve) => {
                    ...
                    try {
                        ...
                        if (xz_tester_vision) {
                            ...
                            log(`: ${JSON.stringify(analysisResult).substring(0, 200)}...`, 'success');
