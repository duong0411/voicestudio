            ...
            <div class="content-panel">
                ...
                <div class="dict-type-panel">
                    ...
                    <el-table ref="dictTypeTable" :data="dictTypeList" style="width: 100%" v-loading="dictTypeLoading"
                        ...
                        element-loading-background="rgba(0, 0, 0, 0.7)" @row-click="handleDictTypeRowClick"
                ...
                <div class="content-area">
                    <el-card class="dict-data-card" shadow="never">
                        <el-table ref="dictDataTable" :data="dictDataList" style="width: 100%"
                            ...
                            element-loading-background="rgba(0, 0, 0, 0.7)" class="transparent-table"
...
::v-deep .dict-type-header .el-button {
    min-width: 72px;
    height: 32px;
    padding: 7px 12px 7px 10px;
    font-size: 12px;
...
::v-deep .dict-type-table .el-table__row {
    cursor: pointer;
}

::v-deep .dict-type-table .el-table__row.current-row .el-button--text {
    color: var(--val-primary) !important;
}
